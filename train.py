...
from dataset_operations import chars, X_train, Y_train, X_dev, Y_dev, X_test, Y_test
...
model = CharLSTM(vocab_size=len(chars), hidden_size=Hyperparameters.lstm_hidden_size, num_layers=Hyperparameters.lstm_num_layers)
...
train_model(model, train_dataloader, criterion, optimizer, epochs=Hyperparameters.epochs)
